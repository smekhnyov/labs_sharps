namespace CSH_Lab1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button_circle
			// 
			button_circle.Location = new Point(13, 71);
			...
			// button_triangle
			// 
			button_triangle.Location = new Point(13, 115);
			...
			// button_rectangle
			// 
			button_rectangle.Location = new Point(13, 159);
			...
			label_square.Location = new Point(13, 426);
			...
			label_perimeter.Location = new Point(134, 426);
			...
			// button_ok
			// 
			button_ok.Location = new Point(13, 203);
